...
- [https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-data-stream](https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-delete-data-stream)
...
- [https://www.elastic.co/docs/explore-analyze/query-filter/tools](https://www.elastic.co/docs/explore-analyze/query-filter/tools)
